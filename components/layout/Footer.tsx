...
const footerLinks: Record<string, { href: string; label: string }[]> = {
  product: [
    ...
    { href: "/sightings", label: "Beer Sightings" },
...
const socialLinks = [
  ...
  {
    href: "https://instagram.com/brewiq",
    label: "Instagram",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        <path
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-foreground">BrewIQ</span>
            </Link>
            <p className="mt-4 text-sm text-muted-foreground">
              Discover, rate, and track craft beers with AI-powered insights.
            </p>
        ...
        <div className="border-t border-border py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} BrewIQ. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground">
