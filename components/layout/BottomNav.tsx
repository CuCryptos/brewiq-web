...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 md:hidden border-t border-border bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 safe-bottom">
            ...
            return (
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-amber shadow-beer transition-transform active:scale-95">
                  <item.icon className="h-7 w-7 text-stout-800" />
                </div>
              </Link>
            );
          }
