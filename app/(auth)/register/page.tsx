...
export default function RegisterPage() {
  ...
  const onSubmit = async (data: RegisterInput) => {
    try {
      ...
      showSuccess("Account created!", "Welcome to BrewIQ");
      router.push("/");
    } catch (error: unknown) {
  ...
  return (
    <Card padding="lg">
      <CardHeader className="text-center">
        ...
        <CardDescription>Join BrewIQ and discover amazing beers</CardDescription>
      </CardHeader>
      ...
      <CardContent className="mt-6">
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          ...
          <Link
            href="/login"
            className="text-amber hover:text-amber-500 font-medium transition-colors"
          >
            Sign in
          </Link>
        </p>
